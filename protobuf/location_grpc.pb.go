...
const (
	Location_SendLocationAndSave_FullMethodName = "/location.Location/SendLocationAndSave"
)
...
type LocationClient interface {
	SendLocationAndSave(ctx context.Context, in *LocationReq, opts ...grpc.CallOption) (*LocationResp, error)
}
...
func (c *locationClient) SendLocationAndSave(ctx context.Context, in *LocationReq, opts ...grpc.CallOption) (*LocationResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LocationResp)
	err := c.cc.Invoke(ctx, Location_SendLocationAndSave_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LocationServer interface {
	SendLocationAndSave(context.Context, *LocationReq) (*LocationResp, error)
...
func (UnimplementedLocationServer) SendLocationAndSave(context.Context, *LocationReq) (*LocationResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SendLocationAndSave not implemented")
}
...
func _Location_SendLocationAndSave_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LocationReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationServer).SendLocationAndSave(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Location_SendLocationAndSave_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServer).SendLocationAndSave(ctx, req.(*LocationReq))
	}
...
var Location_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendLocationAndSave",
			Handler:    _Location_SendLocationAndSave_Handler,
		},
	},
